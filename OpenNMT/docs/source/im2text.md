...
A deep learning-based approach to learning the image-to-text conversion, built on top of the <a href="http://net/">/a> system. It is completely data-driven, hence can be used for a variety of image-to-text problems, such as image captioning, optical character recognition and LaTeX decompilation. 
...
To get started, we provide a toy Math-to-LaTex example. We assume that the working directory is `py` throughout this document.
