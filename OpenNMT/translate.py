...
def main(opt):
    ...
    for i, (src_shard, tgt_shard) in enumerate(shard_pairs):
        ...
        translate_result.append(translator.translate(
            src=src_shard,
            tgt=tgt_shard,
            src_dir=opt.src_dir,
...
def _get_parser():
    ...
    #parser.add_argument('--model', type=str, default='demo-model-shuffle_step_100000.pt')
...
def interface(input_sentence):
    parser = _get_parser()

    opt = parser.parse_args()
    opt.src = input_sentence
    result = main(opt)
    #print(result)
    return result
...
if __name__ == "__main__":
    while True:
    #     original_url = 'http://circle.seeyouyima.com/v2/stacke_topic_detail?bottom_recommend_version=1&mode=2&order_by=reviewed_date&reveal_num=3&topic_id=54908832'
