...
def train_opts(parser):
    ...
    group.add('--max_grad_norm', '-max_grad_norm', type=float, default=5,
              help="If the norm of the gradient vector exceeds this, "
                   ...
                   "max_grad_norm")
    group.add('--dropout', '-dropout', type=float, default=0.2,
...
def translate_opts(parser):
    ...
    group.add('--model', '-model', dest='models', metavar='MODEL',
              nargs='+', type=str, default=['demo-model_step_100000.pt'], required=False,
    ...
    group.add('--replace_unk', '-replace_unk', default='-replace_unk', action="store_true",
    ...
    group = parser.add_argument_group('Logging')
    group.add('--verbose', '-verbose', default='-verbose', action="store_true",
